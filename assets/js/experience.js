...
const exp = [
  {
    ...
    desp: "<li>Worked to migrate Europen Region Project from production to local environment</li> <li>Made changes in the current progressive local environment using AWS.</li> <li>Created whole setup of Elastic Kubernetes Services with 5 worker node using the EC2, EFS for file storage and ECR for registry handling etc.</li>",
  },
  // {
